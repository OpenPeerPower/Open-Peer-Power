...
from openpeerpower.config import _identify_config_schema
from openpeerpower.scripts.check_config import color
...
def main():
    ...
    for package in explore_module("openpeerpower.components"):
        module = importlib.import_module(package)
