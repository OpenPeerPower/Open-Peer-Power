...
def get_component_path(lang, component):
    ...
    if os.path.isdir(os.path.join("openpeerpower", "components", component)):
        return os.path.join(
            "openpeerpower", "components", component, ".translations", f"{lang}.json"
        )
    else:
        return os.path.join(
            "openpeerpower", "components", ".translations", f"{component}.{lang}.json"
        )


def get_platform_path(lang, component, platform):
    """Get the platform translation path."""
    if os.path.isdir(os.path.join("openpeerpower", "components", component, platform)):
        return os.path.join(
            "openpeerpower",
            "components",
            component,
