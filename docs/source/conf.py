...
PROJECT_LONG_DESCRIPTION = ('Open Peer Power is an open-source '
...
sys.path.insert(0, os.path.abspath('../openpeerpower'))
...
latex_documents = [
    (master_doc, 'open-peer-power.tex', 'Open Peer Power Documentation',
     'Open Peer Power Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'open-peer-power', 'Open Peer Power Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Open-Peer-Power', 'Open Peer Power Documentation',
     author, 'Open Peer Power', 'Open-source home automation platform.',
     'Miscellaneous'),
]
