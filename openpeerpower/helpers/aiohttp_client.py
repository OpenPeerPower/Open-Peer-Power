...
from openpeerpower.core import callback, Event
...
@callback
@bind_opp
def async_get_clientsession(opp: OpenPeerPowerType,
...
@callback
@bind_opp
def async_create_clientsession(opp: OpenPeerPowerType,
...
async def async_aiohttp_proxy_web(
        opp: OpenPeerPowerType, request: web.BaseRequest,
...
@bind_opp
async def async_aiohttp_proxy_stream(opp: OpenPeerPowerType,
...
def _async_register_clientsession_shutdown(
        opp: OpenPeerPowerType, clientsession: aiohttp.ClientSession) -> None:
...
@callback
def _async_get_connector(opp: OpenPeerPowerType,
    ...
    connector = aiohttp.TCPConnector(loop=opp.loop,
    ...
    opp.bus.async_listen_once(
        EVENT_OPENPEERPOWER_CLOSE, _async_close_connector)
