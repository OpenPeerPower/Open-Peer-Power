...
from openpeerpower.requirements import pip_kwargs, PackageLoadable
from openpeerpower.util.package import install_package, is_virtual_env
...
def run(args: List) -> int:
    ...
    opp = OpenPeerPower(loop)
    pkgload = PackageLoadable(opp)
