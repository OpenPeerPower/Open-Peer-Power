...
# https://github.com/open-peer-power/open-peer-power/pull/23832
...
class Sun(Entity):
    ...
    def __init__(self, opp):
        ...
        def update_location(event):
            self.location = get_astral_location(self.opp)
            self.update_events(dt_util.utcnow())

        update_location(None)
        self.opp.bus.async_listen(EVENT_CORE_CONFIG_UPDATE, update_location)
    ...
    def update_events(self, utc_point_in_time):
        ...
        async_track_point_in_utc_time(self.opp, self.update_events, self._next_change)
    ...
    def update_sun_position(self, utc_point_in_time):
        ...
        async_track_point_in_utc_time(
            self.opp, self.update_sun_position, utc_point_in_time + delta
        )
