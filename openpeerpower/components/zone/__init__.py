...
async def async_setup(opp, config):
    ...
    def core_config_updated(_):
        ...
        zone.name = opp.config.location_name
        zone.latitude = opp.config.latitude
        zone.longitude = opp.config.longitude
...
async def async_setup_entry(opp, config_entry):
    ...
    zone.entity_id = async_generate_entity_id(ENTITY_ID_FORMAT, name, None, opp)
    opp.async_create_task(zone.async_update_op_state())
