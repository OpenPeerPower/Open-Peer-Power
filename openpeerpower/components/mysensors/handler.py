...
@callback
def _handle_child_update(opp, opp_config, validated):
    ...
    for platform, dev_ids in validated.items():
        ...
        if new_dev_ids:
            discover_mysensors_platform(opp, opp_config, platform, new_dev_ids)
...
@callback
def _handle_node_update(opp, msg):
