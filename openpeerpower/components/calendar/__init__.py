...
async def async_setup(opp, config):
    ...
    # Doesn't work in prod builds of the frontend: open-peer-power-polymer#1289
...
class CalendarEventView(http.OpenPeerPowerView):
...
class CalendarListView(http.OpenPeerPowerView):
