...
class CoverDevice(Entity):
    ...
    async def async_open_cover(self, **kwargs):
        """Open the cover."""
        await self.opp.async_add_job(ft.partial(self.open_cover, **kwargs))
    ...
    async def async_close_cover(self, **kwargs):
        """Close cover."""
        await self.opp.async_add_job(ft.partial(self.close_cover, **kwargs))
    ...
    async def async_set_cover_position(self, **kwargs):
        """Move the cover to a specific position."""
        await self.opp.async_add_job(ft.partial(self.set_cover_position, **kwargs))
    ...
    async def async_stop_cover(self, **kwargs):
        """Stop the cover."""
        await self.opp.async_add_job(ft.partial(self.stop_cover, **kwargs))
    ...
    async def async_open_cover_tilt(self, **kwargs):
        """Open the cover tilt."""
        await self.opp.async_add_job(ft.partial(self.open_cover_tilt, **kwargs))
    ...
    async def async_close_cover_tilt(self, **kwargs):
        """Close the cover tilt."""
        await self.opp.async_add_job(ft.partial(self.close_cover_tilt, **kwargs))
    ...
    async def async_stop_cover_tilt(self, **kwargs):
        """Stop the cover."""
        await self.opp.async_add_job(ft.partial(self.stop_cover_tilt, **kwargs))
