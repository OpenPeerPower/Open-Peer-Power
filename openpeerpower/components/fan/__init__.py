...
class FanEntity(ToggleEntity):
    ...
    async def async_set_speed(self, speed: str):
        ...
        if speed is SPEED_OFF:
            ...
            await self.opp.async_add_job(self.set_speed, speed)
    ...
    async def async_set_direction(self, direction: str):
        """Set the direction of the fan."""
        await self.opp.async_add_job(self.set_direction, direction)
    ...
    async def async_turn_on(self, speed: Optional[str] = None, **kwargs):
        ...
        if speed is SPEED_OFF:
            ...
            await self.opp.async_add_job(ft.partial(self.turn_on, speed, **kwargs))
    ...
    async def async_oscillate(self, oscillating: bool):
        """Oscillate the fan."""
        await self.opp.async_add_job(self.oscillate, oscillating)
