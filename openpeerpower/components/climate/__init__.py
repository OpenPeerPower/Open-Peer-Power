...
class ClimateDevice(Entity):
    ...
    async def async_set_fan_mode(self, fan_mode: str) -> None:
        """Set new target fan mode."""
        await self.opp.async_add_executor_job(self.set_fan_mode, fan_mode)
    ...
    async def async_set_hvac_mode(self, hvac_mode: str) -> None:
        """Set new target hvac mode."""
        await self.opp.async_add_executor_job(self.set_hvac_mode, hvac_mode)
    ...
    async def async_set_swing_mode(self, swing_mode: str) -> None:
        """Set new target swing operation."""
        await self.opp.async_add_executor_job(self.set_swing_mode, swing_mode)
    ...
    async def async_set_preset_mode(self, preset_mode: str) -> None:
        """Set new preset mode."""
        await self.opp.async_add_executor_job(self.set_preset_mode, preset_mode)
    ...
    async def async_turn_aux_heat_on(self) -> None:
        """Turn auxiliary heater on."""
        await self.opp.async_add_executor_job(self.turn_aux_heat_on)
    ...
    async def async_turn_aux_heat_off(self) -> None:
        """Turn auxiliary heater off."""
        await self.opp.async_add_executor_job(self.turn_aux_heat_off)
