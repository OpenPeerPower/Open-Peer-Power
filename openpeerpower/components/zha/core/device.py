...
class ZHADevice(LogMixin):
    ...
    def __init__(self, opp, zigpy_device, zha_gateway):
        ...
        self._unsub = async_dispatcher_connect(
            self.opp, self._available_signal, self.async_initialize
        )
    ...
    def update_available(self, available):
        ...
        if self._available != available and available:
            ...
            async_dispatcher_send(self.opp, self._available_signal, False)
        async_dispatcher_send(
            self.opp, "{}_{}".format(self._available_signal, "entity"), available
        )
        self._available = available
    ...
    def async_get_info(self):
        ...
        reg_device = self.gateway.op_device_registry.async_get(self.device_id)
