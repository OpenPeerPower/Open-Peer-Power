...
class MediaPlayerDevice(Entity):
    ...
    async def async_turn_on(self):
        """Turn the media player on."""
        await self.opp.async_add_job(self.turn_on)
    ...
    async def async_turn_off(self):
        """Turn the media player off."""
        await self.opp.async_add_job(self.turn_off)
    ...
    async def async_mute_volume(self, mute):
        """Mute the volume."""
        await self.opp.async_add_job(self.mute_volume, mute)
    ...
    async def async_set_volume_level(self, volume):
        """Set volume level, range 0..1."""
        await self.opp.async_add_job(self.set_volume_level, volume)
    ...
    async def async_media_play(self):
        """Send play command."""
        await self.opp.async_add_job(self.media_play)
    ...
    async def async_media_pause(self):
        """Send pause command."""
        await self.opp.async_add_job(self.media_pause)
    ...
    async def async_media_stop(self):
        """Send stop command."""
        await self.opp.async_add_job(self.media_stop)
    ...
    async def async_media_previous_track(self):
        """Send previous track command."""
        await self.opp.async_add_job(self.media_previous_track)
    ...
    async def async_media_next_track(self):
        """Send next track command."""
        await self.opp.async_add_job(self.media_next_track)
    ...
    async def async_media_seek(self, position):
        """Send seek command."""
        await self.opp.async_add_job(self.media_seek, position)
    ...
    async def async_select_source(self, source):
        """Select input source."""
        await self.opp.async_add_job(self.select_source, source)
    ...
    async def async_select_sound_mode(self, sound_mode):
        """Select sound mode."""
        await self.opp.async_add_job(self.select_sound_mode, sound_mode)
    ...
    async def async_clear_playlist(self):
        """Clear players playlist."""
        await self.opp.async_add_job(self.clear_playlist)
    ...
    async def async_set_shuffle(self, shuffle):
        """Enable/disable shuffle mode."""
        await self.opp.async_add_job(self.set_shuffle, shuffle)
    ...
    async def async_toggle(self):
        ...
        if hasattr(self, "toggle"):
            ...
            await self.opp.async_add_job(self.toggle)
            return
    ...
    async def async_media_play_pause(self):
        ...
        if hasattr(self, "media_play_pause"):
            # pylint: disable=no-member
            await self.opp.async_add_job(self.media_play_pause)
            return
...
class MediaPlayerImageView(OpenPeerPowerView):
