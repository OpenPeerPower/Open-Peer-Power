...
from openpeerpower.const import ATTR_GPS_ACCURACY, STATE_HOME
from openpeerpower.helpers import discovery
import openpeerpower.helpers.config_validation as cv
from openpeerpower.helpers.event import async_track_utc_time_change
from openpeerpower.helpers.typing import ConfigType, GPSType, OpenPeerPowerType
...
async def async_setup(opp: OpenPeerPowerType, config: ConfigType):
    ...
    async def async_platform_discovered(p_type, info):
        """Load a platform."""
        platform = await setup.async_create_platform_type(opp, config, p_type, {})
