...
class DeviceScanner:
    ...
    async def async_scan_devices(self) -> Any:
        """Scan for devices."""
        return await self.opp.async_add_job(self.scan_devices)
    ...
    async def async_get_device_name(self, device: str) -> Any:
        """Get the name of a device."""
        return await self.opp.async_add_job(self.get_device_name, device)
    ...
    async def async_get_extra_attributes(self, device: str) -> Any:
        """Get the extra attributes of a device."""
        return await self.opp.async_add_job(self.get_extra_attributes, device)
