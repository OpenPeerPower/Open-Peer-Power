...
from openpeerpower.const import (  # noqa: F401 # STATE_PAUSED/IDLE are API
    ATTR_BATTERY_LEVEL,
    ATTR_COMMAND,
    SERVICE_TOGGLE,
    SERVICE_TURN_OFF,
...
class _BaseVacuum(Entity):
    ...
    async def async_return_to_base(self, **kwargs):
        ...
        This method must be run in the event loop.
        """
        await self.opp.async_add_executor_job(partial(self.return_to_base, **kwargs))
    ...
    async def async_clean_spot(self, **kwargs):
        ...
        This method must be run in the event loop.
        """
        await self.opp.async_add_executor_job(partial(self.clean_spot, **kwargs))
...
class VacuumDevice(_BaseVacuum, ToggleEntity):
    ...
    async def async_turn_on(self, **kwargs):
        ...
        This method must be run in the event loop.
        """
        await self.opp.async_add_executor_job(partial(self.turn_on, **kwargs))
    ...
    async def async_turn_off(self, **kwargs):
        ...
        This method must be run in the event loop.
        """
        await self.opp.async_add_executor_job(partial(self.turn_off, **kwargs))
    ...
    async def async_start_pause(self, **kwargs):
        ...
        This method must be run in the event loop.
        """
        await self.opp.async_add_executor_job(partial(self.start_pause, **kwargs))
