...
from openpeerpower.const import CONF_FOR, CONF_PLATFORM, MATCH_ALL
...
from openpeerpower.helpers.event import async_track_same_state, async_track_state_change
...
async def async_attach_trigger(
    ...
    *,
    ...
    unsub = async_track_state_change(
        opp, entity_id, state_automation_listener, from_state, to_state
    )
