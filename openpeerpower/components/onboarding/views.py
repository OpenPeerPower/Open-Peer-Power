...
class UserOnboardingView(_BaseOnboardingView):
    ...
    async def post(self, request, data):
        ...
        async with self._lock:
            ...
            translations = \
                await opp.helpers.translation.async_get_translations(
                    data['language'])

            area_registry = \
                await opp.helpers.area_registry.async_get_registry()
...
class CoreConfigOnboardingView(_BaseOnboardingView):
    ...
    async def post(self, request):
        ...
        async with self._lock:
            ...
            await opp.config_entries.flow.async_init('met', context={
                'source': 'onboarding'
            })
