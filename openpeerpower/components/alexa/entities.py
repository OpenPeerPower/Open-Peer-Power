...
from openpeerpower.components.climate import const as climate
...
class AlexaEntity:
    ...
    def __init__(self, opp, config, entity):
    ...
    def description(self):
        ...
        return f"{description} via Open Peer Power".translate(TRANSLATION_TABLE)
    ...
    def default_display_categories(self):
        ...
        This can be overridden by the user in the Open Peer Power configuration.
    ...
    def serialize_discovery(self):
        ...
        result = {
            ...
            "manufacturerName": "Open Peer Power",
        }
...
class GenericCapabilities(AlexaEntity):
    ...
    def interfaces(self):
        ...
        return [
            ...
            AlexaEndpointHealth(self.opp, self.entity),
            Alexa(self.opp),
        ]
...
class ClimateCapabilities(AlexaEntity):
    ...
    def interfaces(self):
        ...
        yield AlexaThermostatController(self.opp, self.entity)
        yield AlexaTemperatureSensor(self.opp, self.entity)
...
class BinarySensorCapabilities(AlexaEntity):
    ...
    def interfaces(self):
        ...
        sensor_type = self.get_type()
        if sensor_type is self.TYPE_CONTACT:
            yield AlexaContactSensor(self.opp, self.entity)
        elif sensor_type is self.TYPE_MOTION:
            yield AlexaMotionSensor(self.opp, self.entity)
        elif sensor_type is self.TYPE_PRESENCE:
            yield AlexaEventDetectionSensor(self.opp, self.entity)
...
class AlarmControlPanelCapabilities(AlexaEntity):
    ...
    def interfaces(self):
        ...
        if not self.entity.attributes.get("code_arm_required"):
            yield AlexaSecurityPanelController(self.opp, self.entity)
            yield AlexaEndpointHealth(self.opp, self.entity)
            yield Alexa(self.opp)
