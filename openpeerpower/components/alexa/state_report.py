...
from openpeerpower.const import MATCH_ALL, STATE_ON
...
async def async_send_changereport_message(
    opp, config, alexa_entity, *, invalidate_access_token=True
):
    ...
    if (
        ...
        return await async_send_changereport_message(
            opp, config, alexa_entity, invalidate_access_token=False
        )
