...
from openpeerpower.components.alarm_control_panel import ATTR_CODE_FORMAT, FORMAT_NUMBER
from openpeerpower.components.alarm_control_panel.const import (
    SUPPORT_ALARM_ARM_AWAY,
    SUPPORT_ALARM_ARM_HOME,
    SUPPORT_ALARM_ARM_NIGHT,
)
import openpeerpower.components.climate.const as climate
import openpeerpower.components.media_player.const as media_player
...
class AlexaTemperatureSensor(AlexaCapability):
    ...
    def get_property(self, name):
        ...
        if self.entity.domain == climate.DOMAIN:
            unit = self.opp.config.units.temperature_unit
