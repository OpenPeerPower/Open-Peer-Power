...
DEFAULT_VALID_MODES = list(MODE_HOMEKIT_TO_OPP)

CURRENT_MODE_HOMEKIT_TO_OPP = {
    0: CURRENT_HVAC_IDLE,
    1: CURRENT_HVAC_HEAT,
    2: CURRENT_HVAC_COOL,
}
...
class HomeKitClimateDevice(HomeKitEntity, ClimateDevice):
    ...
    def _setup_heating_cooling_target(self, characteristic):
        ...
        self._valid_modes = [MODE_HOMEKIT_TO_OPP[mode] for mode in valid_values]
    ...
    def _update_heating_cooling_current(self, value):
        ...
        self._current_mode = CURRENT_MODE_HOMEKIT_TO_OPP.get(value)
    ...
    def _update_heating_cooling_target(self, value):
        ...
        self._target_mode = MODE_HOMEKIT_TO_OPP.get(value)
        ...
        characteristics = [
            {
                ...
                "value": MODE_OPP_TO_HOMEKIT[hvac_mode],
            }
        ]
        await self._accessory.put_characteristics(characteristics)
