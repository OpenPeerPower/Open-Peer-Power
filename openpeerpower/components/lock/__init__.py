...
class LockDevice(Entity):
    ...
    async def async_lock(self, **kwargs):
        """Lock the lock."""
        await self.opp.async_add_job(ft.partial(self.lock, **kwargs))
    ...
    async def async_unlock(self, **kwargs):
        """Unlock the lock."""
        await self.opp.async_add_job(ft.partial(self.unlock, **kwargs))
    ...
    async def async_open(self, **kwargs):
        """Open the door latch."""
        await self.opp.async_add_job(ft.partial(self.open, **kwargs))
