...
async def test_sunset_trigger(opp, calls):
...
async def test_sunrise_trigger(opp, calls):
...
async def test_sunset_trigger_with_offset(opp, calls):
...
async def test_sunrise_trigger_with_offset(opp, calls):
