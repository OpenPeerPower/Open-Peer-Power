...
from openpeerpower.components.automatic.device_tracker import async_setup_scanner
...
@patch("openpeerpower.components.automatic.device_tracker.open", create=True)
