...
async def test_show_brightness_if_only_command_topic(opp, mqtt_mock):
...
async def test_show_color_temp_only_if_command_topic(opp, mqtt_mock):
...
async def test_show_effect_only_if_command_topic(opp, mqtt_mock):
    """Test the color temp only if a command topic is present."""
    config = {
        light.DOMAIN: {
            "platform": "mqtt",
...
async def test_show_hs_if_only_command_topic(opp, mqtt_mock):
...
async def test_show_white_value_if_only_command_topic(opp, mqtt_mock):
...
async def test_show_xy_if_only_command_topic(opp, mqtt_mock):
