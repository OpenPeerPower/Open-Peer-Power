...
from tests.common import MockDependency, get_test_open_peer_power, load_fixture
...
class TestWeather(unittest.TestCase):
    ...
    def test_setup_minimal(self, mock_yahooweather):
        ...
        assert setup_component(self.opp, "sensor", VALID_CONFIG_MINIMAL)

        state = self.opp.states.get("sensor.yweather_condition")
    ...
    def test_setup_all(self, mock_yahooweather):
        ...
        assert setup_component(self.opp, "sensor", VALID_CONFIG_ALL)
    ...
    def test_setup_bad_raw(self, mock_yahooweather):
        ...
        assert setup_component(self.opp, "sensor", BAD_CONF_RAW)
    ...
    def test_setup_bad_data(self, mock_yahooweather):
        """Test for bad data."""
        assert setup_component(self.opp, "sensor", BAD_CONF_DATA)
