...
@bind_opp
def toggle(opp, entity_id=ENTITY_MATCH_ALL, transition=None):
    """Toggle all or specified light."""
    opp.add_job(async_toggle, opp, entity_id, transition)


async def async_toggle(opp, entity_id=ENTITY_MATCH_ALL, transition=None):
    """Toggle all or specified light."""
    data = {
        key: value
        for key, value in [(ATTR_ENTITY_ID, entity_id), (ATTR_TRANSITION, transition)]
