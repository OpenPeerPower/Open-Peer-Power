...
from tests.common import get_test_open_peer_power, mock_service, mock_storage
...
class TestLight(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        user_light_file = self.opp.config.path(light.LIGHT_PROFILES_FILE)
    ...
    def test_methods(self):
        ...
        # Test is_on
        self.opp.states.set("light.test", STATE_ON)
        assert light.is_on(self.opp, "light.test")

        self.opp.states.set("light.test", STATE_OFF)
        assert not light.is_on(self.opp, "light.test")

        # Test turn_on
        turn_on_calls = mock_service(self.opp, light.DOMAIN, SERVICE_TURN_ON)
        ...
        # Test turn_off
        turn_off_calls = mock_service(self.opp, light.DOMAIN, SERVICE_TURN_OFF)

        common.turn_off(
            self.opp, entity_id="entity_id_val", transition="transition_val"
        )
    ...
    def test_services(self):
        ...
        assert setup_component(
            self.opp, light.DOMAIN, {light.DOMAIN: {CONF_PLATFORM: "test"}}
        )
        ...
        assert light.is_on(self.opp, ent1.entity_id)
        assert light.is_on(self.opp, ent2.entity_id)
        assert light.is_on(self.opp, ent3.entity_id)
        ...
        common.turn_on(self.opp, brightness=0)
        ...
        common.turn_on(
            self.opp, ent1.entity_id, transition=10, brightness=20, color_name="blue"
        )
        common.turn_on(
            self.opp, ent2.entity_id, rgb_color=(255, 255, 255), white_value=255
        )
        common.turn_on(self.opp, ent3.entity_id, xy_color=(0.4, 0.6))
        ...
        common.turn_on(
            self.opp, ent1.entity_id, transition=10, brightness=0, color_name="blue"
        )
        common.turn_on(
            self.opp,
            ent2.entity_id,
        ...
        common.turn_on(self.opp, ent3.entity_id, brightness=0, xy_color=(0.4, 0.6))
        ...
        # Test light profiles
        common.turn_on(self.opp, ent1.entity_id, profile=prof_name)
        # Specify a profile and a brightness attribute to overwrite it
        common.turn_on(self.opp, ent2.entity_id, profile=prof_name, brightness=100)
        ...
        # Test bad data
        common.turn_on(self.opp)
        common.turn_on(self.opp, ent1.entity_id, profile="nonexisting")
        common.turn_on(self.opp, ent2.entity_id, xy_color=["bla-di-bla", 5])
        common.turn_on(self.opp, ent3.entity_id, rgb_color=[255, None, 2])
    ...
    def test_light_profiles(self):
        ...
        common.turn_on(self.opp, ent1.entity_id, profile="test")
        ...
        common.turn_on(self.opp, ent1.entity_id, profile="test_off")
    ...
    def test_default_profiles_group(self):
        ...
        common.turn_on(self.opp, ent.entity_id)
        self.opp.block_till_done()
    ...
    def test_default_profiles_light(self):
        ...
        common.turn_on(self.opp, dev.entity_id)
        self.opp.block_till_done()
